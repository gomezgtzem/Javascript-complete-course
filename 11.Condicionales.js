...
hora >= 8 && hora <= 10
  ? console.log("El café esta en oferta")
  : console.log("El café ¡¡¡NO!!! esta en oferta");
hora > 10 && hora <= 12
  ? console.log("Las tostadas estan en oferta")
  : console.log("Las tostadas ¡¡¡NOOO!!! estan en oferta");
hora > 12 && hora <= 14
  ? console.log("La cerveza está en oferta")
  : console.log("La cerveza ¡¡¡¡NO!!! esta en oferta");
hora > 14 && hora <= 16
  ? console.log("Los menús estan en oferta")
  : console.log("Los menus ¡¡¡¡NO!!! estan en oferta");
hora > 16 && hora <= 23.59
  ? console.log("Tenemos clases de billar en oferta")
  : console.log(" ¡¡¡¡NO!!! tenemos clases");
hora > 0 && hora < 8
  ? console.log("Tenemos masajes en oferta")
  : console.log("¡¡¡¡NO!!! tenemos masajes en oferta");
