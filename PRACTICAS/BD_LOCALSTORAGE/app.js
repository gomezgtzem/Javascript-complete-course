...
function validarNombre(nombre) {
  if (nombre.trim()) {
    if (nombre.length < 10) arrayDatos.push(nombre);
...
function validarApellido1(apellido1) {
  if (apellido1.trim()) {
    if (apellido1.length < 10) arrayDatos.push(apellido1);
    arrayValidacion.push("apellido1");
  }
}
function validarApellido2(apellido2) {
  if (apellido2.trim()) {
    if (apellido2.length < 10) arrayDatos.push(apellido2);
    arrayValidacion.push("apellido2");
  }
}
function validarContrasena(contrasena) {
  if (contrasena.trim()) {
    if (contrasena.length < 10) arrayDatos.push(contrasena);
