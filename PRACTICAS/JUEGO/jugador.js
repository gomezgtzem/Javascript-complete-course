...
class Jugador {
  ...
  update(direccion, tiempoDelta) {
    if (direccion == "down") this.posY += this.velocidad * tiempoDelta;
    if (direccion == "up") this.posY -= this.velocidad * tiempoDelta;
    if (direccion == "downStop") this.posY += this.velocidad * 0;
    if (direccion == "upStop") this.posY -= this.velocidad * 0;
  }
  mover(recojoDelta) {
